...
<?php
	$sumador_total=0;
	$sql=mysqli_query($con, "select * from products, compras, detalle_compra where compras.numero_compras=detalle_compra.numero_compra and  compras.id_compra='$id_compra' and products.id_producto=detalle_compra.id_producto");
