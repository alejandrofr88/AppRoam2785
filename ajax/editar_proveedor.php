<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$sql="UPDATE proveedor SET nombre_proveedor='".$nombre."', telefono_proveedor='".$telefono."', email_proveedor='".$email."', direccion_proveedor='".$direccion."' WHERE id_proveedor='".$id_proveedor."'";
