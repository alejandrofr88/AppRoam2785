						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="estado_factura" name="estado_factura">
									<option value="1" <?php if ($estado_factura==1){echo "selected";}?>>Cotización</option>
									<option value="2" <?php if ($estado_factura==2){echo "selected";}?>>Pagado</option>
									<option value="3" <?php if ($estado_factura==3){echo "selected";}?>>Por Cobrar</option>
								</select>
							</div>
						</div>
